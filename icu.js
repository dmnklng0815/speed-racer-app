...
//
// The key lives in localStorage - the rider's own key on the rider's own
// device. It must never end up in the repository.

const BASE = 'https://intervals.icu/api/v1';
const KEY_STORE = 'hammer.icu.v1';
...
export function saveSettings(s) {
  try { localStorage.setItem(KEY_STORE, JSON.stringify(s)); }
  catch (e) { /* private window - upload still works for this session */ }
}

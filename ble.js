...
import { askCaps, cmdReady, cmdRun, pollLive, pollCumul, setLevelFrame,
         parse, decode } from './fitshow.js?v=b4fba7c';
 ...
 * request fails. Bluefy reimplements Web Bluetooth on top of CoreBluetooth
 * and does not necessarily support every filter form, so a filter that works
 * in Chromium can simply throw there.
 */
